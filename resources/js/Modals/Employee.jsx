    ...
    return <div className="max-w-[912px] relative">
        ...
        <div className="flex gap-6 mb-4">
            ...
            <div>
                ...
                {employee.post ? <div className="text-neutral-500 mb-4">{employee.post}</div> : ``}
                {employee.degree ? <div className="text-neutral-500 mb-4">{employee.degree}</div> : ``}
                {employee.experience ? <div className="text-neutral-500 mb-4">{employee.experience}</div> : ``}
            </div>
        </div>
        <div>{parse(employee.text)}</div>
    </div>
}