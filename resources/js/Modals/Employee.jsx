...
export default (props) => {
    ...
    return <div className="max-w-[912px] relative bg-white rounded-2xl p-6">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 lg:w-8 h-4 lg:h-8 absolute right-4 top-4 lg:-right-12 lg:-top-12 text-black opacity-50 lg:text-white" onClick={e => setModal(null)} viewBox="0 0 30 30" fill="none">
