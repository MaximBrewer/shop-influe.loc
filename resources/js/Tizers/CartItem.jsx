...
export default (props) => {
    ...
    const favorite = () => {
        if (props.auth.user)
            router.patch(route(`cabinet.favorite.parts.toggle`), {
                item: item.part.uniqid
            }, {
                preserveScroll: true
            })
        else
            router.patch(route(`favorite.parts.toggle`), {
                item: item.part.uniqid
            }, {
                preserveScroll: true
            })
    ...
    return <div className="basket-card">
        ...
        <div className="basket-card-caption">
            <div className="basket-card-caption-main">
                <div className="basket-card-name">
                    <p>{item.part.title}</p>
                </div>
                <div className="basket-card-category">
                    <p>{item.part.category.title}</p>
                </div>
                <div className="basket-card-code">
                    <div className="basket-card-code-item">
            ...
            <div className="basket-card-caption-bottom">
